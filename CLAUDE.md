...
**Текущая фаза:** **Phase 6 DONE 2026-05-20** — TxGuard real screen. PR #35 merged on `main` (`45f5108`): form → result toggle, `analyzeTransaction` free function, severity/action color mapping, share/reset, 9 Jest tests. Preceded by **Phase 7 DONE 2026-05-20** — explicit network selector + persist user choice (PR #34, `94d9310`; closes Issue #30). Preceded by **Phase 5 DONE 2026-05-18** — real wallet UI + visual polish + Activity tab: PR #17–#22, #24–#29, #33. 46 jest suites / ~270 tests + 231 Rust workspace tests, all green. First real on-chain ETH transaction broadcast on Sepolia 2026-05-14 (Xiaomi). **Open:** Issue #32 TalkBack a11y verification for ActivityScreen rows (deferred manual QA).
